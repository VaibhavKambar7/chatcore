      ...
      >
        <div className="p-4 flex flex-col gap-4">
          {messages.map((message, index) => (
            <div
              key={index}
              className={`max-w-[70%] p-3 inline-block text-grey-100 border-1 border-gray-500 ${
          ...
          {isResponding && (
            <div className="self-start max-w-[70%] p-3 flex flex-row justify-center items-center bg-gray-100 border-1 border-gray-500">
